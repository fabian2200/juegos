...
const creator = () => {
  ...
  if (isTouchDevice()) {
    ...
    div = "<div class='miDiv draggable-image text-center' style='position: absolute; top: 27%; display: flex; left: 32%; align-items: center; justify-content: center;' draggable='true'><img class='img_drag' data-id='" + img_random + "' style='height: 85px; width: auto; max-width: 100%' id='" + ubi_random + "' src='img/" + img_random + ".png' alt='prueba.png'></div>";
    document.getElementById("imagenes_movil").innerHTML = "";
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        setTimeout(() => {
          ...
          maquina2("bienvenida", 'Hola, soy Genio. <br> En este juego relacionado con los puntos cardinales, Norte, Sur, Este y Oeste, deberás ubicar la imagen en el punto cardinal que se te indique y asi ganar. <br> ¡Tu Puedes!', 50, 1);
        }, 3000)
      }, 2000)
    })
  }, 200)
