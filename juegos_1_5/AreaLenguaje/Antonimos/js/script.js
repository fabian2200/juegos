...
function iniciar() {
    var base_preguntas = readText("js/textos.json");
        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                ...
                setTimeout(() => {
                    ...
                    maquina2(
                        "bienvenida",
                        "Hola, soy Genio. <br> En este juego selecciona los antonimos de las cuatro palabras que se te muestren en el enunciado.",
                        100,
                        1
                    );
                }, 3000);
